...
![Lpwlk logo](./assets/logo/logo-compact-dark.svg#only-dark){ width="300" }
![Lpwlk logo](./assets/logo/logo-compact-light.svg#only-light){ width="300" }
/// caption
///
...
???+ tip "Design references :lucide-globe:"
    ...
    === "UI design"
        ...
        - [Coolors](https://coolors.co/?home) - Free color palette generation tool
    === "Fonts"
...
![Lpwlk logo](./assets/logo/logo-plain-dark.svg#only-dark){ width="300" }
![Lpwlk logo](./assets/logo/logo-plain-light.svg#only-light){ width="300" }
/// caption
///
